    ...
    home-manager.users.piet = {
      xsession.windowManager.bspwm = {
        ...
        settings = {
          ...
          normal_border_color = cfg.colors.ui.tertiaryAccent;
          active_border_color = cfg.colors.ui.secondaryAccentAlt;
          focused_border_color = cfg.colors.ui.secondaryAccent;
